...
/***/ "./src/declarations/print_backend/index.js":
/*!*************************************************!*\
  !*** ./src/declarations/print_backend/index.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   idlFactory: () => (/* reexport safe */ _print_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   print_backend: () => (/* binding */ print_backend)
/* harmony export */ });
...
/* harmony import */ var _print_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./print_backend.did.js */ "./src/declarations/print_backend/print_backend.did.js");
...
const createActor = (canisterId, options = {}) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_print_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
const print_backend = createActor(canisterId);


/***/ }),

/***/ "./src/declarations/print_backend/print_backend.did.js":
/*!*************************************************************!*\
  !*** ./src/declarations/print_backend/print_backend.did.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/print_frontend/src/index.js":
/*!*****************************************!*\
  !*** ./src/print_frontend/src/index.js ***!
  \*****************************************/
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_print_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/print_backend */ "./src/declarations/print_backend/index.js");

document.getElementById("balance").innerText =await _declarations_print_backend__WEBPACK_IMPORTED_MODULE_0__.print_backend.currbala() ;
document.getElementById("with-btn").addEventListener("click", async (e) => {
  var op = document.getElementById("op-am").value;
  op=parseInt(op);
  var cur2=await _declarations_print_backend__WEBPACK_IMPORTED_MODULE_0__.print_backend.withd(op);
  if(cur2==-1){
...
document.getElementById("topup-btn").addEventListener("click", async (e) => {
  ...
  ip=parseInt(ip);
  var cur1=await _declarations_print_backend__WEBPACK_IMPORTED_MODULE_0__.print_backend.topup(ip);
  // const greeting = await hello_backend.greet(name0,name1);
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/print_frontend/src/index.js");
/******/ 	
/******/ })()
;
//# sourceMappingURL=index.js.map