...
import { idlFactory } from './print_backend.did.js';
export { idlFactory } from './print_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PRINT_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./print_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the print_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./print_backend.did.js")._SERVICE>}
 */
export const print_backend = createActor(canisterId);
