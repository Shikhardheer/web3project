...
import { idlFactory } from './print_frontend.did.js';
export { idlFactory } from './print_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PRINT_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./print_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the print_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./print_frontend.did.js")._SERVICE>}
 */
export const print_frontend = createActor(canisterId);
